# Prompt Directive Checkpoint: Downstream Prompts Verification

This directive establishes the verification checklist to confirm that all downstream prompts inside the process intelligence repository are fully complete, rigorous, and actionable.

## 1. Downstream Prompts Checklist
...
- [downstream_audit_mesh_expansion.md](file:///Users/sac/process-intelligence/prompts/downstream_audit_mesh_expansion.md)
  * Verify it contains: Automated capability verification plans and type boundary test requirements.
...
- [downstream_pm4py_benchmark_comparison.md](file:///Users/sac/process-intelligence/prompts/downstream_pm4py_benchmark_comparison.md)
  * Verify it contains: throughput/memory comparison targets, duck-typing vs static typing tests, and result parity checks.
- [downstream_public_standards_expansion.md](file:///Users/sac/process-intelligence/prompts/downstream_public_standards_expansion.md)
